...
const projects: ItemInterface[] = [
  ...
  },
  {
    ...
    github: { frontend: "https://github.com/nicoii-dev/sparc_mobile", backend: "" },
  ...
  },
  {
    ...
    github: { frontend: "https://github.com/nicoii-dev/newsnetwork", backend: "" },
    madeWith: ["react", "typescript", "laravel"],
    type: "web",
  ...
  },
  {
    ...
    github: { frontend: "https://github.com/nicoii-dev/joltpay", backend: "" },
  ...
  },
  {
    ...
    image: "/img/ustp.png",
    github: { frontend: "https://github.com/nicoii-dev/ustp_alumni_react_web", backend: "https://github.com/nicoii-dev/ustp_alumni_laravel_api" },
  ...
  },
  {
    ...
    description:
      "The Oasis Dental Call Center is currently in its inception phase, having been conceived through the collaboration of the Gabucan brothers. Its primary goal is to elevate the overall patient experience within the realm of dental practice, laying the groundwork for synergistic and innovative solutions.",
    image: "/img/oasis.png",
    github: { frontend: "https://github.com/nicoii-dev/oasisdentalcallcenter", backend: "" },
  ...
  },
  {
    ...
    github: { frontend: "https://github.com/nicoii-dev/qualification-exercise", backend: "" },
    madeWith: ["react", "graphql", "typescript"],
    type: "web",
